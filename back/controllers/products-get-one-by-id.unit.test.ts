...
describe(`Products get one by id controller`, function () {
  ...
  describe(`Found`, function () {
    ...
    it(`should call response.send with payload`, function () {
      ...
      assert.strictEqual(response.send.mock.calls[0]?.arguments?.[0], `{"data":{"id":1,"code":"a","name":"a","category":2,"categoryId":2,"description":"a","quantity":1,"inventoryStatus":"INSTOCK","price":10,"rating":3}}`);
    });
  });
});